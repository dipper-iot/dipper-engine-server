...
func init() {
	...
	rulechanDescName := rulechanFields[0].Descriptor()
	...
	rulechanDescRootNode := rulechanFields[1].Descriptor()
	...
	rulechanDescCreatedAt := rulechanFields[3].Descriptor()
	...
	rulechanDescUpdatedAt := rulechanFields[4].Descriptor()
	...
	rulenodeDescNodeID := rulenodeFields[1].Descriptor()
	...
	rulenodeDescOption := rulenodeFields[2].Descriptor()
	...
	rulenodeDescDebug := rulenodeFields[3].Descriptor()
	...
	rulenodeDescEnd := rulenodeFields[4].Descriptor()
	...
	rulenodeDescCreatedAt := rulenodeFields[5].Descriptor()
	...
	rulenodeDescUpdatedAt := rulenodeFields[6].Descriptor()
